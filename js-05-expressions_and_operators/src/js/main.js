...
console.log( undefined <= 0 ); // false xq undefined = NaN y siempre va a dar falso xq NaN no se puede comparar con otro NaN
...
// Uso de post-incremento - primero te entrega el valor actual y una vez terminada esa exp. hace el incremento
number = 20;
...
// Uso de pre-incremento -primero incrementa  y nos da el valor incrementado
number = 40;
